	...
	<div
		...
		<form method="post" action="REQUISITION/insertReq.do" id="form1">
			...
			<table border="0" id="table1" class="table table-bordered table-striped table-hover">
				...
				<tr>
					<td>&nbsp;&nbsp;採購日期：<input type="text" name="pur_id"
						id="pur_date" style="width: 199px;" value="${purVO.pur_date}" readonly="readonly" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td>&nbsp;&nbsp;建檔日期：<input type="text" name="key_date"
						id="key_date" style="width: 199px;" value="${purVO.key_date}" readonly="readonly" /></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;送貨日期：<input type="text" name="delivery_date"
						id="delivery_date" style="width: 199px;" value="${purVO.delivery_date}" readonly="readonly" /></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;金&nbsp;&nbsp;&nbsp;額&nbsp;&nbsp;：<input
			...
			<table border=0 class="table table-bordered table-striped table-hover" id="detailtable">
				...
				<c:forEach var="detailVO" items="${purVO.purs}"
					varStatus="status">
					<tr>
						<td>${status.count}</td>
			...
			<div style="position: absolute; bottom: 30px; right: 40%;">
				...
				<input type="button" id="alter" target="${purVO.pur_id }" value="修改" /> <input type="button"
					id="confirm" value="確認" />
	...
	<script>
		$(function() {
			...
			$('#alter').on('click', function() {
				...
				var url = "DetailUpdateDeletePur.do";
				$.ajax({
					type : "POST",
					url : url,
					data : {"pur_id":pur_id,"action":"update"},
