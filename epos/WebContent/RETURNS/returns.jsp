	...
	<div class="row mt">
		<div class="main">
			<div class="alert alert-info" role="alert">
				<div>
					<a href="#"><span class="glyphicon glyphicon-file"></span>新增</a> <a
						href="#"><span class="glyphicon glyphicon-search"></span>查詢</a> <a
						href="#"><span class="glyphicon glyphicon-pencil"></span>修改</a> <a
						href="#"><span class="glyphicon glyphicon-remove"></span>刪除</a> <a
						href="#"><span class="glyphicon glyphicon-print"></span>列印</a> <a
						href="#"><span id="ok-sign"
						class="glyphicon glyphicon-ok-sign">送出</span></a>
				</div>
			</div>
			<FORM METHOD="post" ACTION="insert.do" name="form1">
				<form class="form-inline">
					<div class="form-group">
						<label for="exampleInputName2"> 退貨單編號</label> <input type="text"
							class="form-control" id="exampleInputName2">
					</div>
					<div class="form-group">
						<label for="exampleInputName2">退貨日期</label> <input type="date"
							class="form-control" id="exampleInputName2">
					</div>
					<div class="form-group">
						<label for="exampleInputEmail2">廠商編號</label> <input type="text"
							class="form-control" id="exampleInputEmail2" placeholder="C00001">
					</div>
					<div class="form-group">
						<label for="exampleInputName2">廠商名稱</label> <input type="text"
							class="form-control" id="exampleInputName2" placeholder="德儀數位">
					</div>
					<div class="form-group">
						<label for="exampleInputName2">修改人員</label> <input type="text"
							class="form-control" id="exampleInputName2" placeholder="E00001">
					</div>
					<div class="form-group">
						<label for="exampleInputName2">修改日期</label> <input type="date"
							class="form-control" id="exampleInputName2">
					</div>
					</br>
					<div class="mainspace">
						<div class="form-group">
							<label for="exampleInputName2"> 備 註</label> <input type="text"
								class="form-control" id="exampleInputName2" placeholder="E00003">
						</div>
						<div class="form-group">
							<label for="exampleInputName2">狀 態</label> <input type="text"
								class="form-control" id="exampleInputName2" placeholder="Ｙ">
						</div>
				</form>
			</FORM>
		</div>
